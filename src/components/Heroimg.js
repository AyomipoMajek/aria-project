...
const Heroimg = () => {
  ...
  const testimoniesToDisplay = () => {
    if (windowWidth >= 768) {
      return testimoniesData.slice(currentTestimonyIndex, currentTestimonyIndex + 3);
    }
    ...
    <div className="homepage">
      ...
      <div className="testimonies">
        ...
        <div className="testimony">
          {testimoniesToDisplay().map((currentTestimony) => (
            <div className="each-testimony" key={currentTestimony.id}>
